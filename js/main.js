...
const LABELS = window.zombieBaseFilterTaxonomy ?? { type: {}, region: {} };
...
function syncStateFromCurrentUrl() {
  ...
  elements.regionFilter.value = LABELS.region[region] ? region : '';
  elements.typeFilter.value = LABELS.type[type] ? type : '';
